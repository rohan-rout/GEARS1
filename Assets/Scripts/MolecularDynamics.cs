...
public class MolecularDynamics : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        SingleStep();
        //Vector3 newPosition = new Vector3(System.Convert.ToSingle(r[0, 0]), System.Convert.ToSingle(r[0, 1]), System.Convert.ToSingle(r[0, 2]));
        //particles[0].transform.position = transform.position + newPosition;
